...
const popupButtons = [
    ...
    { label: 'Card', icon: <IoMdCard />, code: '<div className="flex items-center p-4 justify-center h-[50vh]">\n\t<div className="flex items-center justify-center p-4 bg-yellow-100 rounded-md shadow-md h-1/2">\n\t<div className="flex flex-col items-center justify-center space-y-4">\n\t<h2 className="text-2xl font-bold text-gray-800">Creative Card</h2>\n\t<p className="text-center text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>\n\t<button className="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300">Learn More</button>\n</div>\n</div>\n</div>' },
